...
void makePlots()
{
 ...
 Double_t xsUp_observed[10] = {0.438, 0.339, 0.366, 0.371, 0.335, 0.300, 0.245, 0.219, 0.153, 0.152};
 Double_t xsUp_expected[10] = {0.695, 0.547, 0.436, 0.361, 0.326, 0.292, 0.264, 0.222, 0.199, 0.180};
 ...
 string fileName = "beta_vs_m_excl_mumujj.eps";
 ...
 *******************************************/
 ...
 cout<<endl<<Form("Double_t m_mumujj[%i] = {", nPts);
 for(Int_t i = 0; i<nPts; i++) {
   cout<<m[i];
   if(i<(nPts-1)) cout<<", ";
 }
 cout<<"};"<<endl;
 cout<<Form("Double_t beta_mumujj_observed[%i] = {", nPts);
 for(Int_t i = 0; i<nPts; i++) {
   cout<<beta_observed[i];
   if(i<(nPts-1)) cout<<", ";
 }
 cout<<"};"<<endl;
 cout<<Form("Double_t beta_mumujj_expected[%i] = {", nPts);
 for(Int_t i = 0; i<nPts; i++) {
 ...
 legend->SetHeader("LQ #rightarrow #muq");
