...
//        cout<<"iteration: "<<iteration<<endl;
       ...
       for(Int_t j=0; j<100; j++) {
         ...
         if( (exp(fGS_xsUp_vs_m.Eval(mass))/exp(fGS_xsTh_vs_m.Eval(mass)))>0.5 ) {
           mass_max = (fMass_min+delta_1*(i-1))+delta_2*(j-1);
 ...
 *******************************************/
 ...
 beta_observed_vs_m_band->SaveAs("beta_observed_vs_m_band_enujj.root");

 TPolyLine *beta_expected_vs_m = new TPolyLine(2*nPts, m_expected, beta_expected);
 ...
 beta_expected_vs_m->SaveAs("beta_expected_vs_m_enujj.root");

 TPolyLine *beta_observed_vs_m = new TPolyLine(2*nPts, m_observed, beta_observed);
 ...
 beta_observed_vs_m->SaveAs("beta_observed_vs_m_enujj.root");
