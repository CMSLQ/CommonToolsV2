...
void makePlots()
{
 ...
 string fileName = "beta_vs_m_excl_munujj.eps";
 ...
 *******************************************/
 ...
 cout<<endl<<Form("Double_t m_munujj_observed[%i] = {", 2*nPts);
 for(Int_t i = 0; i<2*nPts; i++) {
   cout<<m_observed[i];
   if(i<(2*nPts-1)) cout<<", ";
 }
 cout<<"};"<<endl;
 cout<<Form("Double_t beta_munujj_observed[%i] = {", 2*nPts);
 for(Int_t i = 0; i<2*nPts; i++) {
   cout<<beta_observed[i];
   if(i<(2*nPts-1)) cout<<", ";
 }
 cout<<"};"<<endl;
 cout<<Form("Double_t m_munujj_expected[%i] = {", 2*nPts);
 for(Int_t i = 0; i<2*nPts; i++) {
   cout<<m_expected[i];
   if(i<(2*nPts-1)) cout<<", ";
 }
 cout<<"};"<<endl;
 cout<<Form("Double_t beta_munujj_expected[%i] = {", 2*nPts);
 for(Int_t i = 0; i<2*nPts; i++) {
 ...
 TLegend *legend = new TLegend(.53,.72,.91,.89);
