...
void makePlots()
{
 ...
 Double_t S_eff[10] = {0.388, 0.421, 0.437, 0.467, 0.518, 0.509, 0.508, 0.578, 0.600, 0.602};
 // array of relative uncertainties on the signal efficiencies (0.1 = 10%)
 Double_t Sigma_S_eff[10] = {0.102, 0.102, 0.102, 0.102, 0.102, 0.102, 0.102, 0.102, 0.102, 0.102};

 // array of N_background for L_int
 Double_t N_bkg[10] = {8.8, 6.2, 3.9, 2.72, 2.72, 1.78, 1.20, 0.99, 0.69, 0.37};
 ...
 Double_t Sigma_N_bkg[10] = {0.26, 0.26, 0.26, 0.26, 0.26, 0.26, 0.26, 0.26, 0.26, 0.26};
 ...
 Int_t N_obs[10] = {5, 3, 3, 3, 3, 2, 1, 1, 0, 0};

 // array of LQ masses for calculation of upXS
 Double_t mData[10] = {200, 225, 250, 280, 300, 320, 340, 400, 450, 500};
 ...
 string fileName = "xs95CL_vs_m_mumujj.eps";

 // axes labels for the final plot
 string title = ";M_{LQ} [GeV];#beta^{2}#times#sigma [pb]";

 // integrated luminosity
 string lint = "#intLdt=34 pb^{-1}";
...
//  cout<<"};"<<endl<<endl;
 ...
 Double_t xsUp_observed[10] = {0.430176, 0.335938, 0.362305, 0.370605, 0.334229, 0.299805, 0.244629, 0.218994, 0.152734, 0.152148};
...
//  cout<<"};"<<endl<<endl;
 ...
 Double_t xsUp_expected[10] = {0.687377, 0.542407, 0.436156, 0.36091, 0.325386, 0.291723, 0.264221, 0.222245, 0.199095, 0.179864};
